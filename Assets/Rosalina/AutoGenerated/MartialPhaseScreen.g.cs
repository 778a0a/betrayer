...
public partial class MartialPhaseScreen
{
    ...
    public Label labelMartialPhase { get; private set; }

    public Label labelMartialPhaseCaption { get; private set; }

    public Button buttonShowInfo { get; private set; }

    public Button buttonAttack { get; private set; }

    public Button buttonDecisiveBattle { get; private set; }

    public Button buttonProvoke { get; private set; }

    public Button buttonSubdue { get; private set; }

    public Button buttonPrivateFight { get; private set; }
    ...
    public MartialPhaseScreen(VisualElement root)
    {
        ...
        labelMartialPhase = Root?.Q<Label>("labelMartialPhase");
        labelMartialPhaseCaption = Root?.Q<Label>("labelMartialPhaseCaption");
        ...
        buttonProvoke = Root?.Q<Button>("buttonProvoke");
        buttonSubdue = Root?.Q<Button>("buttonSubdue");
        buttonPrivateFight = Root?.Q<Button>("buttonPrivateFight");
