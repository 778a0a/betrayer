...
public partial class StrategyPhaseScreen
{
    ...
    public Label labelStrategyPhase { get; private set; }

    public Label labelStrategyPhaseCaption { get; private set; }

    public Button buttonShowInfo { get; private set; }

    public Button buttonOrganize { get; private set; }

    public Button buttonHireVassal { get; private set; }
    ...
    public Label labelAllianceStanceCaption { get; private set; }
    ...
    public StrategyPhaseScreen(VisualElement root)
    {
        ...
        labelStrategyPhase = Root?.Q<Label>("labelStrategyPhase");
        labelStrategyPhaseCaption = Root?.Q<Label>("labelStrategyPhaseCaption");
        ...
        labelAllianceStanceCaption = Root?.Q<Label>("labelAllianceStanceCaption");
